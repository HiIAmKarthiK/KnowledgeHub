...
/*rabbitmq gives our applications a common platform to send and receive messages,
 *This class consumes the data from the Registration service(producer) and helps in validating the credentials. */
@Configuration
